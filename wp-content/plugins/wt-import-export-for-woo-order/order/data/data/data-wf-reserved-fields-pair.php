...
return apply_filters('woocommerce_csv_order_reserved_fields_pair',array(
    ...
    'transaction_id' => array('title'=>'transaction_id','description'=>'Payment transaction id'),    
    'customer_ip_address' => array('title'=>'customer_ip_address','description'=>'Customer ip address'),    
    'customer_user_agent' => array('title'=>'customer_user_agent','description'=>'Customer user agent'),    
    ...
    'shipping_phone' => array('title'=>'shipping_phone','description'=>'shipping_phone'),    
