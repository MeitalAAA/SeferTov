...
$coupon_reserved_fields = apply_filters('woocommerce_csv_product_import_reserved_fields_pair', array(
...
if (is_plugin_active('wt-smart-coupon-pro/wt-smart-coupon-pro.php')):
	//WebToffee smart coupon pro is active
	$coupon_reserved_fields['wt_iew_coupon_categories'] = array('title' => 'Coupon category', 'description' => 'Categories this coupon belongs to');
endif;
return apply_filters('wt_iew_coupon_import_reserved_fields', $coupon_reserved_fields);
