...
class Archive_Search_Not extends Base {
	...
	public function get_name() {
		return __( 'Is Not Search Results', 'gloo_for_elementor' );
	}
...
add_action( 'gloo/modules/interactor/conditions/register', function( $manager ) {
	$manager->register_condition( new Archive_Search_Not() );
} );
