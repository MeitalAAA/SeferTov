...
class PageSettings{
  ...
  public $prefix = 'gloo_frontend_post_creation';
              ...
              <div class="meta-box-sortables ui-sortable">
                <div class="postbox">
                  <div class="postbox-header">                    
                    <h3 class="hndle ui-sortable-handle"><span><?php _e('Post Submission Form Actions', 'gloo_for_elementor'); ?></span></h3>
