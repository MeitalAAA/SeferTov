...
if ( ! class_exists( 'Gloo_Module_Form_OTP' ) ) {

	/**
	 * Define Gloo_Module_Form_OTP class
	 */
	class Gloo_Module_Form_OTP extends Gloo_Module_Base {
		...
		public function create_instance(  ) {
			require  gloo()->modules_path( 'form-otp/inc/module.php' );
			$this->instance = \Gloo\Modules\FormOTP\Module::instance();
		}
