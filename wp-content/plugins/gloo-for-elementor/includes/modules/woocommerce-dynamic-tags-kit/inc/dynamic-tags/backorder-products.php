...
class Backorder_Products extends \Elementor\Core\DynamicTags\Data_Tag {
	...
	public function get_name() {
		return 'gloo-wdt-backorder-products';
	}
	...
	public function get_title() {
		return __( 'Products by Backorder Status', 'gloo_for_elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'status',
			array(
				'label'   => __( 'Backorder Status', 'gloo_for_elementor' ),
