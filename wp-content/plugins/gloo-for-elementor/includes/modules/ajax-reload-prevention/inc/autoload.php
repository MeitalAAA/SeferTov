...
require gloo()->modules_path( 'ajax-reload-prevention/inc/functions.php' );
...
spl_autoload_register( function ( $class ) {
	...
	$allowed_prefixes = array(
		array(
			...
			'base_dir' => gloo()->modules_path( 'ajax-reload-prevention/inc/classes/'),
		),
		/*array(
			'namespace' => 'BBWP\General',
			'base_dir' => gloo()->modules_path( 'ajax-reload-prevention/inc/classes/general'),
		),*/
	);
