<?php
/**
 * Gloo_Module_Form_Fields_For_Range
 */
...
if ( ! class_exists( 'Gloo_Module_Form_Fields_For_Range' ) ) {

	/**
	 * Define Gloo_Module_Form_Fields_For_Terms class
	 */
	class Gloo_Module_Form_Fields_For_Range extends Gloo_Module_Base {
		...
		public function module_id() {
			return 'gloo_form_fields_for_range';
		}
		...
		public function module_name() {
			return __( 'Form Fields For Range', 'gloo_for_elementor' );
		}
		...
		public function create_instance(  ) {
			require  gloo()->modules_path( 'form-fields-for-range/inc/module.php' );
			$this->instance = \Gloo\Modules\Form_Fields_For_Range\Module::instance();
		}
