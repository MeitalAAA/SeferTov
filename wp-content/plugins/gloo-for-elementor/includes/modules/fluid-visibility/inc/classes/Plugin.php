...
class Plugin{
  ...
  public $prefix = 'fluid_visibility';
  ...
  public function wp_style_scripts() {
    ...
    // wp_register_script( $this->prefix('script'),  gloo()->plugin_url( 'includes/modules/fluid-visibility/js/script.js'), array(), '1.0');
  ...
  public function plugin_url() {    
    return trailingslashit(gloo()->plugin_url( 'includes/modules/fluid-visibility/'));
  }

  public function plugin_path() {
    return trailingslashit(gloo()->plugin_path('includes/modules/fluid-visibility'));
  }
