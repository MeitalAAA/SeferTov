...
if ( ! class_exists( 'Gloo_Module_Image_Upload_UI' ) ) {

	/**
	 * Define Gloo_Module_Image_Upload_UI class
	 */
	class Gloo_Module_Image_Upload_UI extends Gloo_Module_Base {
		...
		public function module_id() {
			return 'gloo_form_image_upload_ui';
		}
		...
		public function module_name() {
			return __( 'Image Upload UI', 'gloo' );
		}
		...
		public function create_instance(  ) {
			require  gloo()->modules_path( 'image-upload-ui/inc/module.php' );
			$this->instance = \Gloo\Modules\ImageUploadUI\Module::instance();
		}
