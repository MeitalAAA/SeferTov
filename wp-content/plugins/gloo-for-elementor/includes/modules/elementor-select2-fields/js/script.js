...
function load_google_maps_auto_complete(){
    ...
    bbwp_autocomplete_list = document.getElementsByClassName(gloo_elementor_select2_fields.input_element_class);
    ...
    if(bbwp_autocomplete_list && bbwp_autocomplete_list.length >= 1){
        for (i = 0; i < bbwp_autocomplete_list.length; i++) {
            if(!hasClass(bbwp_autocomplete_list[i], "has_"+gloo_elementor_select2_fields.input_element_class)){
                bbwp_autocomplete_list[i].classList.add("has_"+gloo_elementor_select2_fields.input_element_class);
                if(bbwp_autocomplete_list[i].type == 'text'){
                    ...
                    autocomplete.setComponentRestrictions({
                        country: gloo_elementor_select2_fields.supported_countries,
                      });
