...
class SalesForceAfterSubmit extends \ElementorPro\Modules\Forms\Classes\Action_Base{
  /**
	...
	public function get_label() {
		return __( 'SalesForce CRM Form Submit Action', 'gloo' );
	}
	...
	public function register_settings_section( $widget ) {
		...
		$widget->start_controls_section(
			...
			[
				'label' => __( 'SalesForce CRM Form Submit Action', 'gloo' ),
				'condition' => [
    ...
    $widget->add_control(
			'salesforce_orgid',
			[
				'label' => __( 'SalesForce Organization ID', 'gloo' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'placeholder' => '',
				'label_block' => true,
				'separator' => 'before',
				'description' => __( 'Enter your Salesforce.com Organization ID.', 'gloo' ),
			]
		);
    ...
    foreach($leads_fields as $lead_field){
      $fields_array[$lead_field->name] = $lead_field->label;
        ...
        'label' => __( 'Sales force field name', 'gloo' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'dynamic' => [
					'active' => true,
		...
		$widget->add_control(
			...
			[
				...
				'default' => [
					[
						'salesforce_var_name' => __( 'Form field ID', 'gloo' ),
						'salesforce_var_value' => __( 'Sales force name', 'gloo' ),
					],					
				],
		...
		$widget->add_control(
			...
			[
				'raw' => __( 'Last Name and Email are required.', 'gloo' ),
