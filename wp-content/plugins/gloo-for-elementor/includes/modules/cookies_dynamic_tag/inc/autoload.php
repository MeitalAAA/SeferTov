...
require gloo()->modules_path( 'cookies_dynamic_tag/inc/functions.php' );
...
spl_autoload_register( function ( $class ) {
	...
	$allowed_prefixes = array(
		array(
			...
			'base_dir' => gloo()->modules_path( 'cookies_dynamic_tag/inc/classes/'),
		),
		/*array(
			'namespace' => 'BBWP\General',
			'base_dir' => gloo()->modules_path( 'cookies_dynamic_tag/inc/classes/general'),
		),*/
	);
