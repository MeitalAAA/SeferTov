...
if ( ! class_exists( 'Gloo_Module_Cookies_Form_Action' ) ) {

	/**
	 * Define Gloo_Module_Cookies_Form_Action class
	 */
	class Gloo_Module_Cookies_Form_Action extends Gloo_Module_Base {
		...
		public function module_name() {
			return __( 'Cookies Form Action', 'gloo' );
		}
		...
		public function create_instance(  ) {
			require  gloo()->modules_path( 'cookies_form_action/inc/module.php' );
			$this->instance = \Gloo\Modules\CookiesFormAction\Module::instance();
		}
