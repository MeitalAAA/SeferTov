...
if ( ! class_exists( 'Gloo_Module_BB_Dynamic_Tags' ) ) {

	/**
	 * Define Gloo_Module_Interactor class
	 */
	class Gloo_Module_BB_Dynamic_Tags extends Gloo_Module_Base {
		...
		public function module_name() {
			return __( 'BuddyBoss Dynamic Tags', 'gloo_for_elementor' );
		}
		...
		public function create_instance(  ) {
			require  gloo()->modules_path( 'buddyboss-dynamic-tags/inc/module.php' );
			$this->instance = \Gloo\Modules\BB_Dynamic_Tags\Module::instance();
		}
