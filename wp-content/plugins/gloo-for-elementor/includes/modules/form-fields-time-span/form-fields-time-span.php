<?php
/**
 * Gloo_Module_Form_Fields_For_Time_Span
 */
...
if ( ! class_exists( 'Gloo_Module_Form_Fields_For_Time_Span' ) ) {

	/**
	 * Define Gloo_Module_Form_Fields_For_Terms class
	 */
	class Gloo_Module_Form_Fields_For_Time_Span extends Gloo_Module_Base {
		...
		public function module_id() {
			return 'gloo_form_fields_for_time_span';
		}
		...
		public function module_name() {
			return __( 'Form Fields For Time Span', 'gloo_for_elementor' );
		}
		...
		public function create_instance(  ) {
			require  gloo()->modules_path( 'form-fields-time-span/inc/module.php' );
			$this->instance = \Gloo\Modules\Form_Fields_For_Time_Span\Module::instance();
		}
