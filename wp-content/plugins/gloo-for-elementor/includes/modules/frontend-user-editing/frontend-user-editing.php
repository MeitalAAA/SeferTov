...
if ( ! class_exists( 'Gloo_Module_Form_User_Editing' ) ) {

	/**
	 * Define Gloo_Module_Form_User_Editing class
	 */
	class Gloo_Module_Form_User_Editing extends Gloo_Module_Base {
		...
		public function module_id() {
			return 'gloo_frontend_user_editing';
		}
		...
		public function create_instance() {
			require gloo()->modules_path( 'frontend-user-editing/inc/module.php' );
			$this->instance = \Gloo\Modules\Form_User_Editing\Module::instance();
		}
