...
require gloo()->modules_path( 'composer-field/inc/functions.php' );
...
spl_autoload_register( function ( $class ) {
	...
	$allowed_prefixes = array(
		array(
			...
			'base_dir' => gloo()->modules_path( 'composer-field/inc/classes/'),
		),
		/*array(
			'namespace' => 'BBWP\General',
			'base_dir' => gloo()->modules_path( 'composer-field/inc/classes/general'),
		),*/
	);
