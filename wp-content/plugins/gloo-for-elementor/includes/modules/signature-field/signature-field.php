...
if ( ! class_exists( 'Gloo_Module_Signature_Field' ) ) {

	/**
	 * Define Gloo_Module_Signature_Field class
	 */
	class Gloo_Module_Signature_Field extends Gloo_Module_Base {
		...
		public function module_name() {
			return __( 'Signature Field', 'gloo' );
		}
		...
		public function create_instance(  ) {
			require  gloo()->modules_path( 'signature-field/inc/module.php' );
			$this->instance = \Gloo\Modules\SignatureField\Module::instance();
		}
