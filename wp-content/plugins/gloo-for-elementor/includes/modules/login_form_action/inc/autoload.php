...
require gloo()->modules_path( 'login_form_action/inc/functions.php' );
...
spl_autoload_register( function ( $class ) {
	...
	$allowed_prefixes = array(
		array(
			...
			'base_dir' => gloo()->modules_path( 'login_form_action/inc/classes/'),
		),
		/*array(
			'namespace' => 'BBWP\General',
			'base_dir' => gloo()->modules_path( 'login_form_action/inc/classes/general'),
		),*/
	);
