...
if ( ! class_exists( 'Gloo_Module_Repeater_Field' ) ) {

	/**
	 * Define Gloo_Module_Repeater_Field class
	 */
	class Gloo_Module_Repeater_Field extends Gloo_Module_Base {
		...
		public function create_instance(  ) {
			require  gloo()->modules_path( 'repeater-field/inc/module.php' );
			$this->instance = \Gloo\Modules\Repeater_Field\Module::instance();
		}
