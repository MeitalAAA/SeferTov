<?php
/**
 * Gloo_Module_Form_Fields_For_Terms
 */
...
if ( ! class_exists( 'Gloo_Module_Form_Fields_For_Terms' ) ) {

	/**
	 * Define Gloo_Module_Form_Fields_For_Terms class
	 */
	class Gloo_Module_Form_Fields_For_Terms extends Gloo_Module_Base {
		...
		public function module_id() {
			return 'gloo_form_fields_for_terms';
		}
		...
		public function module_name() {
			return __( 'Form Fields For Terms', 'gloo_for_elementor' );
		}
		...
		public function create_instance(  ) {
			require  gloo()->modules_path( 'form-fields-for-terms/inc/module.php' );
			$this->instance = \Gloo\Modules\Form_Fields_For_Terms\Module::instance();
		}
